...
`app.py` and `preview.py` contain the CustomTkinter/Tkinter desktop UI. The main window stays focused on text entry, printer selection, print action, preset selection, and live preview.
